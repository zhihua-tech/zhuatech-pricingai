...
export const domain={
 ...
 tagline:'让价格建议既响应市场，也守住利润底线',storyTitle:'不是自动改价，<br/>而是把定价依据摆在审批人面前',storyText:'连接成本、库存、竞品与弹性信号，生成透明、受护栏约束、需要人工批准的价格建议。',pattern:[2,4,7,10,13,16,19,22,25,28,31],loginStats:[['3,680','定价对象'],['286','今日建议'],['12','护栏拦截']],loginTitle:'价格策略运营中心',adminDemo:'价格 / 利润 / 竞争',fieldDemo:'建议 / 审核 / 生效',upgrade:{eyebrow:'V1.1 价格沙盘',title:'候选价格影响模拟与发布护栏',summary:'在审批前估算弹性销量、收入和毛利，并检查最低毛利、调价幅度与销量跌幅三类门禁。',api:'POST /api/ai/pricing/simulate-guardrail',metrics:[['31.4%','预计毛利率'],['+8.6%','预计收入'],['REVIEW','护栏结论']]}
}
